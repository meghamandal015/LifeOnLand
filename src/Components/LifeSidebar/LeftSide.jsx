    ...
    <div className="flex flex-col h-screen bg-white pb-4 border-2 rounded-r-xl shadow-lg">
      ...
      <div className="flex  flex-col  pl-2">
        ...
        <div className="flex justify-center items-center pt-4">
          <p className="font-roboto font-bold text-xl text-[#0177b7] no-underline tracking-normal leading-none">
            Events
          </p>
          <p className="font-roboto font-bold text-xl text-[#0177b7] no-underline tracking-normal leading-none mx-2">
            Groups
          </p>
          <p className="font-roboto font-bold text-xl text-[#0177b7] no-underline tracking-normal leading-none">
            Follow
